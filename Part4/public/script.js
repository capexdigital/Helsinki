...
/**
 * Fetch and display all blogs from the server.
 */
    ...
    if (blogs.length === 0) {
      ...
      blogs.forEach(blog => {
        ...
        blogItem.innerHTML = `
          ...
          <button class="delete-btn px-3 py-1 bg-red-500 text-white rounded-md shadow-sm hover:bg-red-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-400" data-id="${blog.id}">
            Delete
          </button>
        `;
